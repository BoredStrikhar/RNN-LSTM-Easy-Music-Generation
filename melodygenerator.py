...
class MelodyGenerator:
    ...
    def save_melody(self, melody, step_duration=0.25, format="midi", file_name="mel.mid"):
        ...
        :return:
        """
        envTest = environment.Environment()
        pathTest = envTest['midiPath']  # для MIDI файлов
        print("Path for MIDI: ")
        print(pathTest)
...
if __name__ == "__main__":
    ...
    seed3 = "67 _ 72 _ _ _ 67 _ _ 69 71 _ _ _ 67"
    melody = mg.generate_melody(seed3, 500, SEQUENCE_LENGTH, 0.1)
    print(melody)
